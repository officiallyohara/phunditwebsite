...
(function($) {
    ...
    $(document).ready( function() {
        ...
        //>> Our Servicess Js Start<<//
        var cycle = {
  onReady: function() {
    var $navItems = $(".nav-pills .nav-link");
    ...
    setInterval(function() {
      ...
      var $nextNavItem = $activeNavItem.parent().next().find(".nav-link");
...
$(document).ready(cycle.onReady);
        ...
        if($('.testimonial-slider-6').length > 0) {
            const testimonialSlider2 = new Swiper(".testimonial-slider-6", {
                spaceBetween: 30,
                speed: 1500,
                loop: true,
                centeredSlides: true,
...
const tabsList = document.querySelector(".our-services-nav");
